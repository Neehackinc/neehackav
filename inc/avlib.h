...
#define AV_SCAN_PORT_NAME                    L"\\NeehackAVScanPort"
#define AV_ABORT_PORT_NAME                   L"\\NeehackAVAbortPort"
#define AV_QUERY_PORT_NAME                   L"\\NeehackAVQueryPort"
